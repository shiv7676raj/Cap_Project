...
TC-REG-UI-03
    [Documentation]
    ...    Registration – Required Fields Left Empty
...
TC-REG-UI-04
    [Documentation]
    ...    Registration – Password and Confirm Don't Match
...
TC-REG-UI-05
    [Documentation]
    ...    Registration – Already Used Username is Rejected
...
TC-NEG-03
    [Documentation]
    ...    Access Transfer Funds Page Without Login
